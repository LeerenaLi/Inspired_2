    ...
    container.insertAdjacentHTML('beforeend', `
        <div class="footer__item footer__item_social footer-social">
            ...
            <ul class="footer-social__list">
                ...
                <li class="footer-social__item">
                    <a href="#" class="footer-social__link footer-social__link_tg footer__link">
        ...
        <div class="footer__item footer__item_development footer-development">
            <ul class="footer-development__list">
                <li class="footer-development__item">
                    Designer: <a href="http://t.me/Mrshmallowww" class="footer__link">Anastasia Ilina</a>
                </li>

                <li class="footer-development__item">
                    Developer: <a href="https://vk.com/leerena_li" class="footer__link">Elena Shipilevskaya</a>
                </li>
            </ul>
        </div>
    `);
